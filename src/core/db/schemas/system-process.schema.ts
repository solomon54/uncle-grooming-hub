/**
 * @file system-process.schema.ts
 * @module core/db/schemas
 *
 * RxDB schema for the SystemProcess aggregate.
 * Specification: ECS v1.3 §1 — SystemProcess
 */

import type { RxJsonSchema } from "rxdb";

export const systemProcessSchema: RxJsonSchema<Record<string, unknown>> = {
  title:      "system_process_journal",
  version:    0,
  primaryKey: "event_id",
  type:       "object",
  properties: {
