 ...
 *
 * RxDB schema for the Transaction aggregate (Commerce Layer).
 * Specification: ECS v1.3 §1 — Transaction
 */

import type { RxJsonSchema } from "rxdb";

export const transactionSchema: RxJsonSchema<Record<string, unknown>> = {
  title:      "transaction_journal",
  version:    0,
  primaryKey: "event_id",
  type:       "object",
  properties: {
