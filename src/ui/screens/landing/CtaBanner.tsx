  ...
  return (
    <>
      ...
      <section
        ...
        style={{ position: "relative", padding: "100px 24px", overflow: "hidden", background: "#171d22" }}
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 10, maxWidth: "680px", margin: "0 auto", textAlign: "center" }}>
          <AnimateIn>
            ...
            <h2 style={{ fontSize: "clamp(36px, 7vw, 76px)", fontWeight: 900, color: "#ffffff", lineHeight: 1.0, marginBottom: "20px" }}>
              Your chair is{" "}
              <span style={{ color: "#e2d609" }}>waiting.</span>
            </h2>
            <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "16px", lineHeight: 1.7, marginBottom: "36px", maxWidth: "440px", margin: "0 auto 36px" }}>
            ...
            <Link
              ...
              style={{
                ...
                padding: "17px 40px", borderRadius: "9999px",
