      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
        ...
        <AnimateIn>
          <div style={{ textAlign: "center", marginBottom: "64px" }}>
            ...
            <h2 style={{ fontSize: "clamp(32px, 5vw, 56px)", fontWeight: 900, color: "#ffffff", lineHeight: 1.1 }}>
              {"We're in Bole, Addis Ababa."}
            </h2>
          </div>
        </AnimateIn>

        <div style={{ display: "grid", gridTemplateColumns: "2fr 3fr", gap: "32px", alignItems: "stretch" }}>
          ...
          <AnimateIn delay={0.15}>
            <a
              ...
              rel="noopener noreferrer"
              style={{
                display: "block", width: "100%", minHeight: "360px",
