 ...
 *
 * Minimal footer — logo, social icons, copyright only.
 */
  ...
  return (
    <a
      ...
      style={{
        ...
        border: "1px solid #2d3840", display: "flex",
...
export function PublicFooter() {
  ...
  return (
    <footer style={{ background: "#0f1317", borderTop: "1px solid rgba(45,56,64,0.6)", padding: "24px" }}>
      <div style={{
